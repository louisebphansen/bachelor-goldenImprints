...
#python3 src/classify.py --data_name wiki6k_train_eva02 --test_data wiki6k_test_eva02 --val_data wiki6k_val_eva02 --feature_col genre --embedding_col eva02_base --epochs 2 --hidden_layer_size 350 --batch_size 32 
